...
var m12 = new Record(meta); m12.set("field", "question_count"); m12.set("label", "Total questions"); m12.set("ftype", "number"); m12.set("group", "Exam"); m12.set("help", "40 by default"); $app.save(m12);
var m13 = new Record(meta); m13.set("field", "reading_count"); m13.set("label", "Reading questions"); m13.set("ftype", "number"); m13.set("group", "Exam"); m13.set("help", "Reading section size"); $app.save(m13);
var m14 = new Record(meta); m14.set("field", "image_count"); m14.set("label", "Image questions target"); m14.set("ftype", "number"); m14.set("group", "Exam"); m14.set("help", "Target count"); $app.save(m14);
var m15 = new Record(meta); m15.set("field", "image_count_min"); m15.set("label", "Image questions min"); m15.set("ftype", "number"); m15.set("group", "Exam"); m15.set("help", "Minimum (18)"); $app.save(m15);
var m16 = new Record(meta); m16.set("field", "image_count_max"); m16.set("label", "Image questions max"); m16.set("ftype", "number"); m16.set("group", "Exam"); m16.set("help", "Maximum (26)"); $app.save(m16);
var m17 = new Record(meta); m17.set("field", "difficulty_profile"); m17.set("label", "Difficulty profile"); m17.set("ftype", "select"); m17.set("group", "Exam"); m17.set("help", "creative+difficult | creative+medium | hard"); m17.set("options", ["creative+difficult", "creative+medium", "hard"]); $app.save(m17);
var m18 = new Record(meta); m18.set("field", "marks_per_question"); m18.set("label", "Marks per question"); m18.set("ftype", "number"); m18.set("group", "Exam"); m18.set("help", "Default marks"); $app.save(m18);
var m19 = new Record(meta); m19.set("field", "max_tokens"); m19.set("label", "Max tokens"); m19.set("ftype", "number"); m19.set("group", "Advanced"); m19.set("help", "LLM generation cap"); $app.save(m19);
var m20 = new Record(meta); m20.set("field", "temperature"); m20.set("label", "Temperature"); m20.set("ftype", "number"); m20.set("group", "Advanced"); m20.set("help", "LLM sampling temp"); $app.save(m20);
var m21 = new Record(meta); m21.set("field", "timeout_s"); m21.set("label", "Timeout (s)"); m21.set("ftype", "number"); m21.set("group", "Advanced"); m21.set("help", "LLM call timeout"); $app.save(m21);
var m22 = new Record(meta); m22.set("field", "retries"); m22.set("label", "LLM retries"); m22.set("ftype", "number"); m22.set("group", "Advanced"); m22.set("help", "Retry count"); $app.save(m22);
var m23 = new Record(meta); m23.set("field", "img_retries"); m23.set("label", "Image retries"); m23.set("ftype", "number"); m23.set("group", "Advanced"); m23.set("help", "Per-model image retries"); $app.save(m23);
var m24 = new Record(meta); m24.set("field", "push_pb_base"); m24.set("label", "Push base URL"); m24.set("ftype", "text"); m24.set("group", "Push"); m24.set("help", "Client PocketBase base URL"); $app.save(m24);
var m25 = new Record(meta); m25.set("field", "push_pb_email"); m25.set("label", "Push email"); m25.set("ftype", "text"); m25.set("group", "Push"); m25.set("help", "Client PB admin email"); $app.save(m25);
var m26 = new Record(meta); m26.set("field", "push_pb_pass"); m26.set("label", "Push password"); m26.set("ftype", "text"); m26.set("group", "Push"); m26.set("help", "Client PB admin password"); $app.save(m26);
var m27 = new Record(meta); m27.set("field", "push_subject_id"); m27.set("label", "Subject id"); m27.set("ftype", "text"); m27.set("group", "Push"); m27.set("help", "Subject record id on client PB"); $app.save(m27);
var m28 = new Record(meta); m28.set("field", "push_exam_type"); m28.set("label", "Exam type on push"); m28.set("ftype", "text"); m28.set("group", "Push"); m28.set("help", "exam_type for the auto-created exam (mock/ubt/practice/official)"); $app.save(m28);
var m29 = new Record(meta); m29.set("field", "push_exam_status"); m29.set("label", "Exam status on push"); m29.set("ftype", "select"); m29.set("group", "Push"); m29.set("help", "draft = review-then-publish | published = immediate"); m29.set("options", ["draft", "published"]); $app.save(m29);
