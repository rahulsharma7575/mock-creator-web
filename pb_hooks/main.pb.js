...
var m3 = new Record(meta); m3.set("field", "image_primary"); m3.set("label", "Image provider"); m3.set("ftype", "select"); m3.set("group", "Images"); m3.set("help", "fal-ai (Fal.ai) | z-image (Magnific) | black-forest-labs/flux.2-klein-4b (OpenRouter)"); m3.set("options", ["fal-ai/z-image/turbo", "z-image", "black-forest-labs/flux.2-klein-4b"]); $app.save(m3);
var m4 = new Record(meta); m4.set("field", "image_fallback"); m4.set("label", "Fallback image model"); m4.set("ftype", "text"); m4.set("group", "Images"); m4.set("help", "Deprecated - providers fall back automatically, keep empty"); $app.save(m4);
