...
var m2 = new Record(meta); m2.set("field", "gemini_model"); m2.set("label", "Gemini author model"); m2.set("ftype", "text"); m2.set("group", "LLM"); m2.set("help", "Direct Google Gemini model for authoring: gemini-3.6-flash, gemini-3.5-flash, gemini-3.5-flash-lite, gemini-2.5-pro"); $app.save(m2);
...
var m5 = new Record(meta); m5.set("field", "image_primary"); m5.set("label", "Image provider"); m5.set("ftype", "select"); m5.set("group", "Images"); m5.set("help", "fal-ai (Fal.ai) | z-image (Magnific) | black-forest-labs/flux.2-klein-4b (OpenRouter)"); m5.set("options", ["fal-ai/z-image/turbo", "z-image", "black-forest-labs/flux.2-klein-4b"]); $app.save(m5);
var m6 = new Record(meta); m6.set("field", "image_fallback"); m6.set("label", "Fallback image model"); m6.set("ftype", "text"); m6.set("group", "Images"); m6.set("help", "Deprecated - providers fall back automatically, keep empty"); $app.save(m6);
var m7 = new Record(meta); m7.set("field", "tts_model"); m7.set("label", "TTS model"); m7.set("ftype", "select"); m7.set("group", "Audio"); m7.set("help", "Model that reads the listening scripts aloud. Options load from the models API."); m7.set("options", ["fish-audio/s2.1-pro-free:free", "microsoft/mai-voice-2-flash", "x-ai/grok-voice-tts-1.0"]); $app.save(m7);
var m8 = new Record(meta); m8.set("field", "tts_fallback_model"); m8.set("label", "Fallback TTS model"); m8.set("ftype", "select"); m8.set("group", "Audio"); m8.set("help", "Used only if the primary TTS model fails or times out."); m8.set("options", ["microsoft/mai-voice-2-flash", "fish-audio/s2.1-pro-free:free", "x-ai/grok-voice-tts-1.0"]); $app.save(m8);
var m9 = new Record(meta); m9.set("field", "tts_fallback_voice"); m9.set("label", "Fallback voice"); m9.set("ftype", "text"); m9.set("group", "Audio"); m9.set("help", "Voice id used when the primary voice is unavailable (e.g. ko-KR-Haena)."); $app.save(m9);
var m10 = new Record(meta); m10.set("field", "question_count"); m10.set("label", "Total questions"); m10.set("ftype", "number"); m10.set("group", "Exam"); m10.set("help", "40 by default"); $app.save(m10);
var m11 = new Record(meta); m11.set("field", "reading_count"); m11.set("label", "Reading questions"); m11.set("ftype", "number"); m11.set("group", "Exam"); m11.set("help", "Reading section size"); $app.save(m11);
var m12 = new Record(meta); m12.set("field", "image_count"); m12.set("label", "Image questions target"); m12.set("ftype", "number"); m12.set("group", "Exam"); m12.set("help", "Target count"); $app.save(m12);
var m13 = new Record(meta); m13.set("field", "image_count_min"); m13.set("label", "Image questions min"); m13.set("ftype", "number"); m13.set("group", "Exam"); m13.set("help", "Minimum (18)"); $app.save(m13);
var m14 = new Record(meta); m14.set("field", "image_count_max"); m14.set("label", "Image questions max"); m14.set("ftype", "number"); m14.set("group", "Exam"); m14.set("help", "Maximum (26)"); $app.save(m14);
var m15 = new Record(meta); m15.set("field", "difficulty_profile"); m15.set("label", "Difficulty profile"); m15.set("ftype", "select"); m15.set("group", "Exam"); m15.set("help", "creative+difficult | creative+medium | hard"); m15.set("options", ["creative+difficult", "creative+medium", "hard"]); $app.save(m15);
var m16 = new Record(meta); m16.set("field", "marks_per_question"); m16.set("label", "Marks per question"); m16.set("ftype", "number"); m16.set("group", "Exam"); m16.set("help", "Default marks"); $app.save(m16);
var m17 = new Record(meta); m17.set("field", "max_tokens"); m17.set("label", "Max tokens"); m17.set("ftype", "number"); m17.set("group", "Advanced"); m17.set("help", "LLM generation cap"); $app.save(m17);
var m18 = new Record(meta); m18.set("field", "temperature"); m18.set("label", "Temperature"); m18.set("ftype", "number"); m18.set("group", "Advanced"); m18.set("help", "LLM sampling temp"); $app.save(m18);
var m19 = new Record(meta); m19.set("field", "timeout_s"); m19.set("label", "Timeout (s)"); m19.set("ftype", "number"); m19.set("group", "Advanced"); m19.set("help", "LLM call timeout"); $app.save(m19);
var m20 = new Record(meta); m20.set("field", "retries"); m20.set("label", "LLM retries"); m20.set("ftype", "number"); m20.set("group", "Advanced"); m20.set("help", "Retry count"); $app.save(m20);
var m21 = new Record(meta); m21.set("field", "img_retries"); m21.set("label", "Image retries"); m21.set("ftype", "number"); m21.set("group", "Advanced"); m21.set("help", "Per-model image retries"); $app.save(m21);
var m22 = new Record(meta); m22.set("field", "push_pb_base"); m22.set("label", "Push base URL"); m22.set("ftype", "text"); m22.set("group", "Push"); m22.set("help", "Client PocketBase base URL"); $app.save(m22);
var m23 = new Record(meta); m23.set("field", "push_pb_email"); m23.set("label", "Push email"); m23.set("ftype", "text"); m23.set("group", "Push"); m23.set("help", "Client PB admin email"); $app.save(m23);
var m24 = new Record(meta); m24.set("field", "push_pb_pass"); m24.set("label", "Push password"); m24.set("ftype", "text"); m24.set("group", "Push"); m24.set("help", "Client PB admin password"); $app.save(m24);
var m25 = new Record(meta); m25.set("field", "push_subject_id"); m25.set("label", "Subject id"); m25.set("ftype", "text"); m25.set("group", "Push"); m25.set("help", "Subject record id on client PB"); $app.save(m25);
var m26 = new Record(meta); m26.set("field", "push_exam_type"); m26.set("label", "Exam type on push"); m26.set("ftype", "text"); m26.set("group", "Push"); m26.set("help", "exam_type for the auto-created exam (mock/ubt/practice/official)"); $app.save(m26);
var m27 = new Record(meta); m27.set("field", "push_exam_status"); m27.set("label", "Exam status on push"); m27.set("ftype", "select"); m27.set("group", "Push"); m27.set("help", "draft = review-then-publish | published = immediate"); m27.set("options", ["draft", "published"]); $app.save(m27);
var m28 = new Record(meta); m28.set("field", "audio_gap_ms"); m28.set("label", "Gap between clips (ms)"); m28.set("ftype", "number"); m28.set("group", "Audio"); m28.set("help", "Pause between sentences inside a clip. 300-500 ms sounds natural; lower feels rushed."); $app.save(m28);
var m29 = new Record(meta); m29.set("field", "sample_rate"); m29.set("label", "Sample rate (Hz)"); m29.set("ftype", "number"); m29.set("group", "Audio"); m29.set("help", "MUST match the TTS model: 44100 for fish-audio / grok-voice, 24000 for mai-voice. Wrong rate makes audio play too fast or slow."); $app.save(m29);
var m30 = new Record(meta); m30.set("field", "audio_workers"); m30.set("label", "Parallel audio workers"); m30.set("ftype", "number"); m30.set("group", "Audio"); m30.set("help", "How many clips are synthesized at the same time. 4 is safe for most machines."); $app.save(m30);
var m31 = new Record(meta); m31.set("field", "active"); m31.set("label", "Config enabled"); m31.set("ftype", "bool"); m31.set("group", "General"); m31.set("help", "Use this config"); $app.save(m31);
