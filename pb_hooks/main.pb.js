...
var m28 = new Record(meta); m28.set("field", "dedup_enabled"); m28.set("label", "Check duplicates against previous mockups"); m28.set("ftype", "bool"); m28.set("group", "LLM"); m28.set("help", "Compares new questions against the last N mock exams in the end-user app and steers the author away from repeats"); $app.save(m28);
var m29 = new Record(meta); m29.set("field", "dedup_sets"); m29.set("label", "Check last N mockups"); m29.set("ftype", "number"); m29.set("group", "LLM"); m29.set("help", "How many of the latest mock exams to check for duplicates (default 5)"); $app.save(m29);
var m30 = new Record(meta); m30.set("field", "audio_gap_ms"); m30.set("label", "Gap between clips (ms)"); m30.set("ftype", "number"); m30.set("group", "Audio"); m30.set("help", "Pause between sentences inside a clip. 300-500 ms sounds natural; lower feels rushed."); $app.save(m30);
var m31 = new Record(meta); m31.set("field", "sample_rate"); m31.set("label", "Sample rate (Hz)"); m31.set("ftype", "number"); m31.set("group", "Audio"); m31.set("help", "MUST match the TTS model: 44100 for fish-audio / grok-voice, 24000 for mai-voice. Wrong rate makes audio play too fast or slow."); $app.save(m31);
var m32 = new Record(meta); m32.set("field", "audio_workers"); m32.set("label", "Parallel audio workers"); m32.set("ftype", "number"); m32.set("group", "Audio"); m32.set("help", "How many clips are synthesized at the same time. 4 is safe for most machines."); $app.save(m32);
