...
createApp({
  ...
  methods:{
    ...
    onPdfPick(){const f=this.$refs.pdfTestInput&&this.$refs.pdfTestInput.files&&this.$refs.pdfTestInput.files[0];if(f)this.runPdfTest(f);},
    pdfPick(){if(this.pdfTest.busy)return;this.$refs.pdfTestInput.click();},
